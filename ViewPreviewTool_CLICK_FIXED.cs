    ...
    public class ViewPreviewApplication : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            try
            {
                ...
                buttonData.ToolTip = "Show preview of selected view";
                buttonData.LongDescription = "Select a view in the Project Browser and click to see a preview.";
    ...
    public class ShowPreviewCommand : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                {
                    Autodesk.Revit.UI.TaskDialog.Show("View Preview", "Please select a single view in the Project Browser to preview.");
                ...
                if (view == null)
                {
                    Autodesk.Revit.UI.TaskDialog.Show("View Preview", "Selected element is not a view.\n\nPlease select a view from the Project Browser.");
                    return Result.Failed;
                }
                ...
                {
                    Autodesk.Revit.UI.TaskDialog.Show("View Preview", "Sheet views are not supported.\n\nPlease select a model view.");
                    return Result.Failed;
                }
        ...
        private void LoadViewImage()
        {
            try
            {
                ...
                var options = new ImageExportOptions
                {
                    ...
                    ImageResolution = ImageResolution.DPI_300,  // Higher quality
                    PixelSize = 2000,  // Larger image
                ...
                {
                    trans.Start();
                    doc.Export(tempPath, fileName, options);
                    trans.Commit();
                }
                {
                    ...
                    if (File.Exists(expectedFile))
                    {
                        ...
                        statusLabel.Text = "Preview loaded successfully. Double-click image to toggle zoom.";
        ...
        private void ShowErrorImage(string errorMessage)
        {
            ...
            using (Graphics g = Graphics.FromImage(errorImg))
            {
                ...
                using (Font msgFont = new Font("Segoe UI", 11))
                {
                    ...
                    SizeF msgSize = g.MeasureString(errorMessage, msgFont);
                    g.DrawString(errorMessage, msgFont, Brushes.Gray, 
                        (600 - msgSize.Width) / 2, 200);
                }
